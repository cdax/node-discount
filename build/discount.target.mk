...
$(OBJS): | $(obj).target/libmarkdown.stamp
...
$(builddir)/discount.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/discount.node: TOOLSET := $(TOOLSET)
$(builddir)/discount.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/discount.node
# Add target alias
.PHONY: discount
discount: $(builddir)/discount.node

# Short alias for building this executable.
.PHONY: discount.node
discount.node: $(builddir)/discount.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/discount.node
